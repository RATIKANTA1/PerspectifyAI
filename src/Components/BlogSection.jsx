...
function BlogSection() {
  return (
    <section id='blog' className="w-full mx-auto py-20 bg-black">
      {/* Blog Header */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 px-3">
        ...
        <div className="bg-gray-800 p-8 rounded-lg shadow-lg xl:h-[24rem] py-10">
        ...
        <div className="bg-gray-800 p-8 rounded-lg shadow-lg xl:h-[24rem] py-10">
          ...
          <p className="text-blue-400 text-center mb-4 font-semibold">- MMA Fighter</p>
          <p className="text-gray-300 text-lg text-center leading-relaxed">
